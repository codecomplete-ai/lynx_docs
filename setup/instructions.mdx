...
### Lynx Config
When you first connect Lynx to your environment, Lynx will automatically generate a config file at `~/.lynxconfig` with details about your environment, including OS name and version, CLI tools, and more. 
